...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    "chat.noHistory": "Aucune conversation",
    "chat.renameHint": "Double-cliquer pour renommer",
    "notfound.title": "404",
  ...
  ar: {
    ...
    "chat.history": "السجل",
    "chat.noHistory": "لا توجد محادثات بعد",
    "chat.renameHint": "انقر مرتين لإعادة التسمية",
    "notfound.title": "404",
  ...
  es: {
    ...
    "chat.renameHint": "Doble clic para renombrar",
    "notfound.title": "404",
